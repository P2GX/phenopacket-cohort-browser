...
All notable changes to the Cohort Explorer are documented here.
...
- All seven original tabs: Demographics, Diagnoses, Genes (incl. Gene × Diagnosis explorer), Phenotypic Features (incl. onset-over-time), Diseases, Measurements (incl. box plots, per-assay distributions, measurements-over-time) and Patient Browser.
